...
internal static partial class NativeMethods
{
    ...
    internal const uint WmCloseKeyStop = WmApp + 2;
    internal const uint WmWinHDown = WmApp + 3;
    internal const uint ModAlt = 0x0001;
    internal const uint ModControl = 0x0002;
    internal const uint WsExToolWindow = 0x00000080;
    internal const uint WsExNoActivate = 0x08000000;
    internal const int HotkeyId = 1;
    internal const int TimerId = 2;
    internal const int WinHHoldTimerId = 3;
    internal const int WinHHoldMs = 500;
    ...
    internal const uint MenuExitId = 1;
    internal const uint MenuInterceptWinHId = 2;
    internal const uint MenuEnterCloseId = 3;
    internal const uint MenuSpaceCloseId = 4;
    internal const uint MenuListeningId = 5;
    internal const uint MenuHotkeyId = 6;
    internal const int FocusWatchIntervalMs = 250; // bar auto-closes on focus change; heal within a quarter second
